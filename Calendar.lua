...
function M.new()
  ...
  local function create_date_button( parent, index )
    local button = m.api.CreateFrame( "Button", "OctoMailCalendarDay" .. index .. "Button", parent, "UIPanelButtonTemplate" )
  ...
  local function create_dropdown( parent, name, on_select )
    local dropdown = m.api.CreateFrame( "Frame", "OctoMailDropdown" .. name, parent, "UIDropDownMenuTemplate" )
  ...
  local function create_calendar()
    local frame = m.api.CreateFrame( "Frame", "OctoMailCalendarFrame" )
